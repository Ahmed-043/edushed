...
class ClassTimetable extends StatefulWidget {
  ...
  ClassTimetable({required this.title, required this.timetable});
                                ...
                                Expanded(//top left
                                  ...
                                  child: LayoutBuilder(
                                    builder: (context, constraints) {
                                      ...
                                      int sectionNum = widget.timetable[index].section;
                                                        ...
                                                        child: LayoutBuilder( builder: (context,constraints){
                                                          ...
                                                          return Text("${widget.timetable[index].slot[d][s].subject.isEmpty ? "" :
                                                            widget.timetable[index].slot[d][s].subject} "
                                                                "\n ${ widget.timetable[index].slot[d][s].room != 0 ? "Room ${widget.timetable[index].slot[d][s].room} ${widget.timetable[index].slot[d][s].teacher}" : "" }"
